...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/fpd_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpd_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpd_mul.tcl
