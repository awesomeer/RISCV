...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/fpd_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpd_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpd_add.tcl
