...
#
# Generated by export_simulation on Tue Aug 31 20:31:36 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './fpd_cmp.sh' script.

./fpd_cmp.sh -reset_run
...
./fpd_cmp.sh -noclean_files

For more information on the script, please type './fpd_cmp.sh -help'.
