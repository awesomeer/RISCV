...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/fpd_div_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpd_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpd_div.tcl
