...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/Dividers_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dividers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dividers.tcl
