...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/Divideru_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divideru.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divideru.tcl
