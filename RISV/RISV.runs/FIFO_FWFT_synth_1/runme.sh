...
HD_PWD='C:/Users/mithi/RISV/RISV.runs/FIFO_FWFT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_FWFT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_FWFT.tcl
